...
Also known as the [rule of three](https://en.wikipedia.org/wiki/Rule_of_three_(computer_programming):

 - popularized by Martin Fowler (1999), attributed to Don Roberts
 
--

Packages are the means for sharing code:
...
- we can indicate a weaker reliance using `Suggests` (additional test)
